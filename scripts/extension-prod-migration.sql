-- Festag Chrome Extension — production SQL (idempotent)
-- Run in Supabase SQL Editor when db push is blocked.
...
alter table extension_writing_events
  ...
  check (action in (
    'clearer', 'professional', 'shorter', 'feedback', 'casual', 'explain', 'translate'
  ));
