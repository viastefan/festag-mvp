...
(function(){try{
  ...
  var bg = legalLanding
    ? '#ffffff'
    : docsLanding
      ? (t === 'dark' ? '#0B0F0D' : t === 'read' ? '#F7F4EC' : '#FCFCFD')
    : devPortal
      ? (t === 'dark' ? '#0B0F0D' : '#f7f8f8')
    : t === 'dark'
      ? '#0B0F0D'
      : t === 'read'
        ? '#F7F4EC'
  ...
  document.documentElement.setAttribute('data-font', font);
        ...
        <style dangerouslySetInnerHTML={{ __html: `
          ...
          html[data-theme="dark"]  { background:#0B0F0D; color-scheme:dark; }
          ...
          html[data-theme="dark"][data-auth-landing] { background:#0B0F0D; border-radius:0 !important; }
          html[data-theme="light"][data-docs-landing] { background:#FCFCFD; }
          html[data-theme="dark"][data-docs-landing] { background:#0B0F0D; }
          html[data-theme="read"][data-docs-landing] { background:#F7F4EC; }
          html[data-theme="dark"]  body { background:#0B0F0D; }
          ...
          html[data-theme="dark"][data-auth-landing] body { background:#0B0F0D; border-radius:0 !important; }
          html[data-theme="light"][data-docs-landing] body { background:#FCFCFD; }
          html[data-theme="dark"][data-docs-landing] body { background:#0B0F0D; }
          html[data-theme="read"][data-docs-landing] body { background:#F7F4EC; }
          /* Developer portal canvas — dark green / light warm white. */
          html[data-theme="dark"][data-dev-portal] { background:#0B0F0D; }
          html[data-theme="dark"][data-dev-portal] body { background:#0B0F0D; }
