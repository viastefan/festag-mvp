  ...
  return (
    <LegalDoc>
      ...
      <p>
        ...
        Projektabwicklung an. Konkrete Leistungen ergeben sich aus dem gewählten Paket
      ...
      <ol>
        ...
        <li>
          Mit Eingang der Zahlung (SEPA-Überweisung mit eindeutigem Verwendungszweck, abgewickelt
          durch den Zahlungsdienstleister) kommt der Vertrag zustande.
        </li>
        <li>Der Kunde erhält eine Bestätigung per E-Mail.</li>
      </ol>

      <h2 id="preise">§ 4 Preise und Zahlung</h2>
      <p>
        ...
        Verwendungszweck. Zahlungen werden technisch über die Enjyn® Gruppe abgewickelt.
      </p>

      <h2 id="leistung">§ 5 Leistungserbringung und Mitwirkung</h2>
      <p>
      ...
      <p>
        ...
        Fehler im gelieferten Code, Performance-Probleme und Funktionsabweichungen vom
        Pflichtenheft kostenlos behoben. Details sind in der Plattform unter „Garantie-Details“
        einsehbar.
      </p>

      <h2 id="nutzungsrechte">§ 7 Nutzungsrechte</h2>
      <p>
