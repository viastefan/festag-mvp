    ...
    <main className="onb-root" data-theme={themeAttr}>
      <style>{`
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .onb-root[data-theme="dark"]  { background:#0A0D14; color:#E8E8E5; }
        ...
        .onb-root[data-theme="dark"]  .onb-shell { background:#0E1219; box-shadow:0 28px 72px -20px rgba(0,0,0,0.6), 0 1px 2px rgba(0,0,0,0.3); }
        ...
        .preview-dark   { background:#0A0D14; }
