  ...
  return (
    <div style={{ position:'relative', flex:1, overflow:'hidden', minWidth:0, minHeight:'100%' }}>
      ...
      <style>{`
        ...
        @keyframes slideInBlock3{from{opacity:0;transform:translateX(100px);}to{opacity:1;transform:translateX(0);}}
        @keyframes slideInBlock4{from{opacity:0;transform:translateX(120px);}to{opacity:1;transform:translateX(0);}}
        @keyframes slideInBlock5{from{opacity:0;transform:translateX(140px);}to{opacity:1;transform:translateX(0);}}
        .block1{animation:slideInBlock1 .8s .1s cubic-bezier(.16,1,.3,1) both;}
        .block2{animation:slideInBlock2 .8s .2s cubic-bezier(.16,1,.3,1) both;}
        .block3{animation:slideInBlock3 .8s .3s cubic-bezier(.16,1,.3,1) both;}
        .block4{animation:slideInBlock4 .8s .4s cubic-bezier(.16,1,.3,1) both;}
