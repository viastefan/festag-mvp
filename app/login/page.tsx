...
// ── Desktop Pixel Blocks (right panel on image) ──
  ...
  return (
    <div style={{ position: 'relative', overflow: 'hidden', width: '100%', height: '100%' }}>
      ...
      <p style={{ position: 'absolute', bottom: 18, left: 36, fontSize: 10, color: 'rgba(255,255,255,.22)', letterSpacing: '.05em', zIndex: 2, lineHeight: 1.5 }}>
        © 2026 Festag GmbH<br/>Alle Rechte vorbehalten
      </p>
    </div>
  )
}
...
// ══════════════════════════════════════════════════════════════════
// CSS — MOBILE ONLY (all changes scoped to max-width:768px)
        ...
        <div className="form-scroll">
          <div className="frm" style={{ width: '100%', maxWidth: 400 }}>
            ...
            <h1 style={{
              ...
              letterSpacing: '-.65px', lineHeight: 1.1, marginBottom: 8,
            }}>
              {isDev ? 'Systemzugang.' : isReg ? 'Konto erstellen.' : greeting}
            </h1>
            <p style={{
              fontSize: 15, color: 'var(--text-secondary)',
              marginBottom: 26, lineHeight: 1.55, fontWeight: 500,
            }}>
            ...
            {error && (
              <div style={{
                ...
                border: '1px solid rgba(220,70,70,.2)', borderRadius: 12,
                fontSize: 14, color: 'var(--red)', marginBottom: 18, lineHeight: 1.5,
              }}>
                {error}
              </div>
            )}
            ...
            {view === 'login' && (<>
              ...
              <div style={{ marginTop: 8, marginBottom: 18 }}>
                <PrimaryBtn label="Anmelden →" onClick={doLogin} loading={loading}/>
              </div>
              <Divider/>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            {view === 'register' && (<>
              ...
              <div style={{ marginTop: 8 }}>
                <PrimaryBtn label="Konto erstellen →" onClick={doRegister} loading={loading}/>
              </div>
            ...
            {/* ── DEV ── */}
            {view === 'dev' && (<>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '11px 15px', background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 12, marginBottom: 24 }}>
              ...
              <div style={{ marginTop: 8 }}>
                <PrimaryBtn label="Einloggen →" onClick={doDev} loading={loading}/>
              </div>
