  ...
  return (
    <main style={{ background:'#FAFBFC', minHeight:'100vh', color:'#202532' }}>
      <style>{`
        ...
        * { box-sizing:border-box; }
        ...
        .blog-title {
          ...
          margin:0 0 18px; color:#0F141B;
        }
        .blog-lead {
          font-size:18px; line-height:1.6;
          color:#4E5567; margin:0 0 12px;
          font-weight:500;
        }
        .blog-meta {
          font-size:12px; color:#9aa1ad; font-weight:500;
          margin:0 0 48px; letter-spacing:.01em;
        }
        ...
        h2.blog-h {
          font-size:24px; font-weight:600; letter-spacing:-.014em;
          color:#0F141B; margin:48px 0 14px;
        }
        h3.blog-h3 {
        ...
        .blog-quote {
          ...
          border-left:3px solid #5B647D;
          background:#F6F9FC; border-radius:0 12px 12px 0;
          font-size:16px; line-height:1.6; color:#202532;
        ...
        .blog-cta {
          ...
          padding:34px 32px;
          border-radius:18px;
          background:linear-gradient(135deg, #202532 0%, #2B3142 100%);
          color:#fff;
        ...
        .blog-cta p {
          margin:0; font-size:13.5px; opacity:.78; line-height:1.5; max-width:380px;
        }
        .blog-cta-btn {
      ...
      <div className="blog-shell">
        ...
        <p className="blog-eyebrow">Produkt · Funktionen</p>
        <h1 className="blog-title">Mitbeobachter: Stille Stakeholder ohne Lärm</h1>
        ...
        <p className="blog-meta">17. Mai 2026 · 4 Minuten Lesezeit</p>
        ...
        <div className="blog-hero" aria-label="Mitbeobachter-Konzept">
          ...
          <div className="hero-node">
            <div className="hero-circle" style={{ background:'#9aa1ad' }}>👁</div>
        ...
        <div className="blog-cta">
          <div>
            <h3>Bereit, jemanden mitschauen zu lassen?</h3>
            <p>Im Dashboard unter „Persönlicher Bereich → Mitbeobachter" einrichten. Dauert keine 30 Sekunden.</p>
          </div>
          <Link href="/observers" className="blog-cta-btn">Mitbeobachter öffnen →</Link>
        </div>
      </div>
    </main>
  )
