...
const DELIVERY_OPTIONS: DeliveryOption[] = [
  ...
  },
  {
    ...
    label: 'Bestehendem Entwickler zuweisen',
    meta: 'Bestehenden Entwickler im Workspace einem neuen Projekt zuordnen.',
    tagroAfter: 'Dein Entwickler bekommt das Projekt direkt im Execution Panel.',
    postCreate: 'assign-existing',
  },
  {
    id: 'invite_new_dev',
    label: 'Entwickler neu einladen',
    meta: 'Neuen Entwickler per E-Mail-Einladung zum Projekt holen.',
    tagroAfter: 'Sobald der Einladungslink eingelöst ist, sieht die Person das Projekt.',
