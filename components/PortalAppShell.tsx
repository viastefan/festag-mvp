...
export const PORTAL_APP_SHELL_CSS = `
  ...
  [data-theme="classic-dark"] .portal-app-shell {
    ...
    --portal-muted: var(--festag-night-ink-3, #8891a0);
    ...
    --portal-nav-item: var(--nav-off-text, #8891a0);
    --portal-nav-item-active: #E6E6EA;
    --portal-nav-item-hover: var(--festag-night-ink, #E6E6EA);
    --portal-nav-section: var(--text-muted, #8891a0);
    --portal-nav-util: var(--nav-off-text, #8891a0);
