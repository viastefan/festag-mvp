...
export const PORTAL_APP_SHELL_CSS = `
  ...
  [data-theme="classic-dark"] .portal-app-shell {
    ...
    --portal-soft: var(--festag-night-ink-2, rgba(228, 228, 234, 0.58));
    --portal-nav-active-bg: var(--festag-night-fill-hover, rgba(255, 255, 255, 0.075));
    --portal-nav-hover-bg: var(--festag-night-fill, rgba(255, 255, 255, 0.055));
    --portal-nav-item: var(--nav-off-text, rgba(228,228,234,0.52));
    --portal-nav-item-active: var(--nav-on-text, #E4E4EA);
    --portal-nav-item-hover: var(--festag-night-ink, #E4E4EA);
    --portal-nav-section: var(--text-muted, rgba(228,228,234,0.40));
    --portal-nav-util: var(--nav-off-text, rgba(228,228,234,0.52));
    --portal-nav-util-hover: var(--festag-night-ink, #E4E4EA);
    --portal-nav-avatar-bg: rgba(255,255,255,.05);
    --portal-nav-avatar-border: var(--festag-night-line, rgba(255,255,255,.065));
    --portal-pill-bg: var(--festag-night-fill-hover, rgba(255,255,255,.075));
    ...
    --portal-btn-outline-bg: rgba(255,255,255,.035);
    --portal-btn-outline-border: var(--festag-night-line-strong, rgba(255,255,255,.10));
    --portal-btn-outline-text: var(--festag-night-ink, #E4E4EA);
    --portal-row-hover: var(--portal-nav-hover-bg);
