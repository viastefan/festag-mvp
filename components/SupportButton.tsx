 ...
 * Klick oeffnet ein Popover mit E-Mail, WhatsApp und Schnell-Nachricht.
 * Ersetzt das frueher schwebende SupportWidget unten rechts.
 */
  ...
  return (
    <div ref={wrapRef} style={{ position:'relative', flexShrink:0 }}>
      <style>{`
        ...
        .sb-fab { transition:background .12s, transform .1s; }
        .sb-fab:hover { background:var(--surface-2); }
        .sb-fab:active { transform:scale(.94); }
      `}</style>
