...
/* Dark auth surfaces — boost presence */
:is(.al-root, .dl-root, .ae-root)[data-theme="dark"] .fa-ambient .fa-ambient__top,
:is(.al-root, .dl-root, .ae-root)[data-theme="dark"] .fa-ambient .fa-ambient__bottom,
:is(.al-root, .dl-root, .ae-root)[data-theme="dark"] .fa-ambient .fa-ambient__left,
:is(.al-root, .dl-root, .ae-root)[data-theme="dark"] .fa-ambient .fa-ambient__right {
