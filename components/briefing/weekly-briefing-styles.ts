...
.wsb-shell {
  ...
  max-height: min(720px, calc(92vh - 48px));
...
.wsb-line--active .wsb-word--pending {
  color: color-mix(in srgb, var(--fp-text, #1E1E20) 34%, transparent);
  opacity: 0.55;
}
...
.wsb-versand-edit:hover,
.wsb-versand-trigger:hover,
.wsb-versand-trigger.is-open {
  background: #f5f5f7;
  box-shadow:
    0 2px 6px rgba(15, 15, 16, 0.08),
    0 1.5px 1px rgba(46, 47, 51, 0.12);
...
.wsb-versand-menu-wrap {
  position: relative;
}

.wsb-versand-trigger svg:last-child {
  transition: transform 0.15s ease;
}

.wsb-versand-trigger.is-open svg:last-child {
...
.wsb-versand-menu-item:hover {
  background: #f5f5f7;
}

.wsb-versand-menu-icon {
  flex-shrink: 0;
  width: 28px;
  height: 28px;
  display: inline-flex;
...
.wsb-versand-menu-title {
  font-size: 13px;
  font-weight: 500;
  color: #1E1E20;
}

.wsb-versand-menu-hint {
  font-size: 11px;
  font-weight: 400;
  color: #86868b;
}
...
.wsb-tagro-inline-composer,
.wsb-tagro-inline .tagro-composer {
  width: 100%;
}
...
.wsb-share-edit:hover,
.wsb-share-trigger:hover,
.wsb-share-trigger.is-open {
  background: #f5f5f7;
  box-shadow:
    0 2px 6px rgba(15, 15, 16, 0.08),
    0 1.5px 1px rgba(46, 47, 51, 0.12);
...
.wsb-share-trigger svg:last-child {
  transition: transform 0.15s ease;
}

.wsb-share-trigger.is-open svg:last-child {
  transform: rotate(180deg);
}
...
[data-theme="classic-dark"] .wsb-connect-sheet {
  background: var(--festag-black-content, #111816);
...
.wsb-back:hover { color: var(--fp-text, #1E1E20); }
...
.wsb-tool:hover { color: var(--fp-text, #1E1E20); }
...
[data-theme="classic-dark"] .festag-modal-surface--briefing {
  ...
  --wsb-accent: #5b647d;
  --wsb-accent-deep: #4f586d;
  --wsb-accent-soft: color-mix(in srgb, #5b647d 16%, var(--festag-black-popup, #1A2521));
  --wsb-accent-wave: color-mix(in srgb, #5b647d 48%, transparent);
  --wsb-apple-gray: color-mix(in srgb, var(--festag-black-content, #111816) 94%, #fff 6%);
  --wsb-apple-gray-soft: color-mix(in srgb, var(--festag-black-content, #111816) 92%, #fff 8%);
  --wsb-apple-gray-highlight: color-mix(in srgb, var(--festag-black-content, #111816) 90%, #fff 10%);
}
[data-theme="dark"] .wsb-shell,
[data-theme="classic-dark"] .wsb-shell {
  background: var(--festag-black-popup, #1A2521);
  --wsb-shell-bg: var(--festag-black-popup, #1A2521);
}
...
[data-theme="dark"] .wsb-picker-menu button:hover,
[data-theme="classic-dark"] .wsb-picker-menu button:hover,
[data-theme="dark"] .wsb-picker-menu button.on,
[data-theme="classic-dark"] .wsb-picker-menu button.on {
  background: rgba(255, 255, 255, 0.1);
}
...
[data-theme="dark"] .wsb-versand-label,
[data-theme="classic-dark"] .wsb-versand-label {
  color: #f4f4f5;
}
[data-theme="dark"] .wsb-versand-edit,
...
[data-theme="dark"] .wsb-versand-edit:hover,
[data-theme="classic-dark"] .wsb-versand-edit:hover,
[data-theme="dark"] .wsb-versand-trigger:hover,
...
[data-theme="classic-dark"] .wsb-versand-trigger.is-open {
  background: color-mix(in srgb, var(--festag-black-popup, #1A2521) 88%, #fff 12%);
}
...
[data-theme="classic-dark"] .wsb-versand-menu-item:hover {
  background: rgba(255, 255, 255, 0.06);
}
[data-theme="dark"] .wsb-versand-menu-icon,
[data-theme="classic-dark"] .wsb-versand-menu-icon {
  background: rgba(255, 255, 255, 0.08);
  color: #f4f4f5;
}
[data-theme="dark"] .wsb-versand-menu-title,
[data-theme="classic-dark"] .wsb-versand-menu-title {
  color: #f4f4f5;
}
[data-theme="dark"] .wsb-share-label,
[data-theme="classic-dark"] .wsb-share-label {
  color: #f4f4f5;
}
[data-theme="dark"] .wsb-share-sub,
[data-theme="classic-dark"] .wsb-share-sub {
  color: #86868b;
}
[data-theme="dark"] .wsb-share-edit,
...
[data-theme="dark"] .wsb-share-edit:hover,
[data-theme="classic-dark"] .wsb-share-edit:hover,
[data-theme="dark"] .wsb-share-trigger:hover,
...
[data-theme="classic-dark"] .wsb-share-menu-item:hover {
  background: rgba(255, 255, 255, 0.06);
}
[data-theme="dark"] .wsb-share-menu-icon,
[data-theme="classic-dark"] .wsb-share-menu-icon {
  background: rgba(255, 255, 255, 0.08);
  color: #f4f4f5;
}
[data-theme="dark"] .wsb-share-menu-title,
[data-theme="classic-dark"] .wsb-share-menu-title {
  color: #f4f4f5;
}
