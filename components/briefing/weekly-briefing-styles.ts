...
[data-theme="classic-dark"] .festag-modal-surface--briefing {
  ...
  --wsb-accent: #5b647d;
  --wsb-accent-deep: #4f586d;
  --wsb-accent-soft: color-mix(in srgb, #5b647d 16%, var(--festag-black-popup, #1A1A1E));
  --wsb-accent-wave: color-mix(in srgb, #5b647d 48%, transparent);
  --wsb-apple-gray: color-mix(in srgb, var(--festag-black-content, #0E0E10) 94%, #fff 6%);
  --wsb-apple-gray-soft: color-mix(in srgb, var(--festag-black-content, #0E0E10) 92%, #fff 8%);
  --wsb-apple-gray-highlight: color-mix(in srgb, var(--festag-black-content, #0E0E10) 90%, #fff 10%);
}
...
[data-theme="classic-dark"] .wsb-versand-trigger.is-open {
  background: color-mix(in srgb, var(--festag-black-popup, #1A1A1E) 88%, #fff 12%);
}
