...
const AUTH_LANDING_STYLES_BASE = `
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .al-root[data-theme="dark"] > *:not(.al-sand-ambient):not(.fa-ambient) {
          position:relative;
          z-index:1;
        }
        ...
        /* Code-entry H1 — one sentence, second clause quieter. */
        .al-title--split {
          display:block;
        }
        .al-title--split .al-title-lead {
          color:inherit;
          font-weight:inherit;
        }
        .al-title--split .al-title-rest {
          color:var(--al-text-muted, #8891a0);
          font-weight:inherit;
        }
        .al-root[data-theme="dark"] .al-title--split .al-title-rest {
        ...
        .al-input {
          width:100%;
          /* +2px vs CTA — field reads slightly taller. */
        ...
        .al-root:not([data-theme="dark"]) .al-input:-webkit-autofill:focus {
          background-color:transparent !important;
          border:var(--festag-input-border-width-focus, 2px) solid var(--festag-input-border-focus, rgba(255,255,255,0.78)) !important;
          -webkit-box-shadow:0 0 0 1000px ${AUTH_INPUT_AUTOFILL_LIGHT} inset !important;
          box-shadow:0 0 0 1000px ${AUTH_INPUT_AUTOFILL_LIGHT} inset !important;
          -webkit-text-fill-color:#1e1e20 !important;
        }
        ...
        /* Ghost/primary CTAs — soft slate + hairline. Idle still quieter than ready. */
        ...
        .al-root[data-theme="dark"] .al-btn-apple {
          ...
          color:var(--festag-btn-dark-fg, rgba(245,245,247,0.90));
          border:1px solid var(--festag-btn-dark-border, rgba(255,255,255,0.12)) !important;
        ...
        .al-root[data-theme="dark"] .al-btn-google,
        .al-root[data-theme="dark"] .al-btn-apple {
          background:var(--festag-btn-dark-bg, rgba(186,194,210,0.08)) !important;
          color:var(--festag-btn-dark-fg, rgba(245,245,247,0.90)) !important;
          border:1px solid var(--festag-btn-dark-border, rgba(255,255,255,0.12)) !important;
        ...
        .al-root[data-theme="dark"] .al-btn-apple:focus-visible:not(:disabled) {
          background:var(--festag-btn-dark-bg-hover, rgba(186,194,210,0.12)) !important;
          ...
          box-shadow:var(--festag-btn-dark-shadow-hover, 0 1px 2px rgba(0,0,0,0.14)) !important;
        }
        ...
        .al-root[data-theme="dark"] .al-btn-apple:active:not(:disabled) {
          background:var(--festag-btn-dark-bg-active, rgba(186,194,210,0.16)) !important;
        ...
        .al-root[data-theme="dark"] .al-input:active {
          ...
          background-color:transparent !important;
          background-image:none !important;
          border:var(--festag-input-border-width, 1px) solid var(--festag-input-border-hover, rgba(255,255,255,0.40)) !important;
          box-shadow:none;
          outline:none;
        }
        ...
        @media (min-width: 769px) {
          ...
          /* Desktop: compact 40/42 soft rects. */
          .al-btn {
            height:var(--festag-btn-height, 40px);
            min-height:var(--festag-btn-height, 40px);
            font-size:13px;
        ...
        @media (max-width: 768px) {
          ...
          /* Mobile — compact soft rects (8px), still tappable. */
          .al-btn {
            height:40px;
            min-height:40px;
            font-size:13px;
          ...
          /* Dark mobile — soft slate ghosts; Weiter ready = warm bone. */
          ...
          .al-root[data-theme="dark"] .al-input:active {
            background:transparent !important;
            background-color:transparent !important;
            border-color:var(--festag-input-border-hover, rgba(255,255,255,0.40)) !important;
          }
          .al-root[data-theme="dark"] .al-input:not(:placeholder-shown),
          .al-root[data-theme="dark"] .al-input:focus,
          .al-root[data-theme="dark"] .al-input:focus-visible {
