...
const AUTH_LANDING_STYLES_BASE = `
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        .al-root {
          ...
          position:relative;
          isolation:isolate;
          /* Same column as onboarding --mob-content-max (chips / connect rows). */
          ...
          background:var(--festag-auth-canvas, #FBF7EE);
          color:#1e1e20;
          display:flex;
        ...
        /* Dark — flat Festag Night canvas, no sand wash / ambient. */
        .al-root[data-theme="dark"]::before {
          display:none;
        }
        .al-root[data-theme="dark"] {
          ${AUTH_CHROME_VARS_DARK}
          /* Primary Dusk — cinematic OS canvas (same language as mobile onboarding). */
          background:
        ...
        html:has(.al-root[data-theme="dark"]),
        html:has(.al-root[data-theme="dark"]) body {
        ...
        @keyframes alPageEnter { from { opacity:0.92; } to { opacity:1; } }
        .al-root:not(.exiting):not(.al-panel-enter):not(.al-soft-enter) { animation: alPageEnter 0.08s cubic-bezier(.16,1,.3,1) both; }
        ...
        .al-root.al-panel-enter:not(.exiting) {
          animation: alPanelEnter 0.2s cubic-bezier(.16,1,.3,1) both;
        }
        ...
        /* Current fluid mark — shown on login/register light chrome */
        .al-root.al-root--centered .al-wordmark::before {
          display:none !important;
        }
        .al-root.al-root--centered .al-wordmark-img,
        .al-root.al-root--centered .al-wordmark-img--fluid {
        ...
        /* Fluid mark is light-on-dark art — ink it for the light auth canvas */
        .al-root.al-root--centered[data-theme="light"] .al-wordmark-img--fluid {
          filter:brightness(0) saturate(100%);
          opacity:0.9;
        }
        .al-root.al-root--centered[data-theme="light"] .al-wordmark {
          color:#1e1e20;
        }
        .al-root.al-root--centered .al-wordmark {
          width:40px;
          height:40px;
        }
        .al-wordmark-mark,
        ...
        .al-account-hint-link:hover,
        .al-account-hint-link:focus-visible {
          color:#1e1e20;
          text-decoration:none;
          background:none !important;
          box-shadow:none !important;
        }
        .al-root[data-theme="dark"] .al-account-hint {
          color:rgba(245,245,247,0.42);
        }
        .al-root[data-theme="dark"] .al-account-hint-link {
          color:rgba(245,245,247,0.78);
        }
        .al-root[data-theme="dark"] .al-account-hint-link:hover,
        .al-root[data-theme="dark"] .al-account-hint-link:focus-visible {
          color:#F5F5F7;
        }
        .al-footer-center {
          display:inline-flex;
        ...
        /* Soft mode: register keeps the /Benutzer field slot; login cold has no gap. */
        .al-root.al-soft-mode[data-auth-mode="signup"] .al-hero-secondary,
        .al-root.al-soft-enter[data-auth-mode="signup"] .al-hero-secondary,
        .al-root.al-soft-mode .al-signin-head--has-user .al-hero-secondary,
        .al-root.al-soft-enter .al-signin-head--has-user .al-hero-secondary {
        ...
        h1.al-title.al-title-display {
          font-size:var(--al-hero-display-size, 29px) !important;
          font-weight:400;
          line-height:var(--al-hero-display-lh, 31px) !important;
        ...
        /* Glassy H1 lead must stay inked on light — never inherit dark-canvas white. */
        .al-root[data-theme="light"] .al-glassy-hero .al-gword-lead,
        .al-root[data-theme="light"] .al-glassy-hero .al-gword-inner:not(.al-hero-gray) {
          color:#1e1e20 !important;
        }
        .al-root[data-theme="dark"] .al-glassy-hero .al-gword-lead,
        .al-root[data-theme="dark"] .al-glassy-hero .al-gword-inner:not(.al-hero-gray) {
          color:#F5F5F7 !important;
        }
          .al-hero-copy .al-ws-path,
          .al-hero-copy button.al-ws-path--editable {
          font-size:var(--al-hero-name-size, 29px);
          line-height:var(--al-hero-name-lh, 31px);
          letter-spacing:var(--auth-tracking-display, 0.006em);
          font-weight:400;
          width:100%;
          margin:0;
        ...
        .al-ws-name-line:not(.has-value):not(:focus-within)::after {
          ...
          border-radius:0;
          background:var(--festag-caret, #7E889F);
        ...
        /* Canvas SSOT: inline-flex — check sits 8px after the name, not at the row’s far edge. */
        .al-ws-path-check-row {
          ...
          max-width:100%;
          box-sizing:border-box;
          min-height:var(--al-hero-name-lh, var(--al-hero-display-lh, 31px));
        }
        ...
        .al-ws-path-check-row .al-ws-path,
        .al-ws-path-check-row button.al-ws-path--editable {
          ...
          align-self:center;
          line-height:var(--al-hero-name-lh, var(--al-hero-display-lh, 31px));
        }
        .al-ws-path-check-row .al-ws-path,
        .al-ws-path-check-row button.al-ws-path--editable,
        .al-ws-path-check-row .auth-ws-path,
        ...
        .al-ws-ok-badge {
          ...
          flex-shrink:0;
          align-self:center;
          /* Optical center next to Aeonik 29 — not baseline, not cap-height drift. */
          position:relative;
          top:0;
          line-height:0;
        ...
        .al-ws-ok-badge svg {
          display:block;
          /* Phosphor Check sits a hair high in the viewBox — nudge into the disc. */
          transform:translateY(0.5px);
        }
        .al-ws-ok-badge--checking {
          background:transparent;
          color:var(--al-text-muted, #8891a0);
          animation:none;
        }
        .al-ws-ok-spinner {
          ...
          animation:alWsOkSpin 0.7s linear infinite;
        }
        ...
        .al-title-display {
          font-size:var(--al-hero-display-size, 29px);
          line-height:var(--al-hero-display-lh, 31px);
          letter-spacing:var(--auth-tracking-display, 0.006em);
          margin:0;
        }
        ...
        @media (max-width: 768px) {
          .al-root[data-auth-mode="signup"] .al-content {
            max-height:999px;
            transition:max-height 0.2s cubic-bezier(.16,1,.3,1), opacity 0.14s ease;
          }
          .al-content--ws-collapse {
        ...
        .al-signin-stack {
          ...
          width:100%;
          max-width:100%;
          /* Gutter so 2px strokes never clip on overflow-x parents (al-root). */
          padding-inline:3px;
          box-sizing:border-box;
          align-items:stretch;
        }
        /* One column width — Google / Apple / email / Weiter / SSO match onboarding cards. */
        .al-signin-stack > *,
        .al-signin-stack .al-method-group,
        .al-signin-stack .al-sso-group,
        .al-signin-stack .al-btn,
        .al-signin-stack .al-input,
        .al-signin-stack input.al-input,
        .al-signin-stack .al-field,
        .al-signin-stack .al-divider {
          width:100% !important;
        ...
        /*
         * Light CTAs — idle Weiter is quiet (clarify-chip hairline, muted ink, not white plate).
         * Ready / Apple / SSO stay white plates. Google stays Festag primary blue.
         */
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary:not(.al-btn-primary--ready) {
          background:transparent !important;
        ...
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary:not(.al-btn-primary--ready):disabled {
          opacity:1 !important;
          cursor:default;
        }
        ...
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary.al-btn-primary--ready {
          ...
          border:1px solid var(--festag-btn-ready-border, rgba(30, 30, 32, 0.10)) !important;
          outline:none !important;
          box-shadow:none !important;
          opacity:1 !important;
          cursor:pointer;
        ...
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary.al-under-cta-switch:hover:not(:disabled) {
          ...
          color:#1e1e20 !important;
          border-color:var(--festag-btn-dark-border-hover, rgba(30, 30, 32, 0.10)) !important;
          outline:none !important;
          box-shadow:none !important;
        }
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary.al-btn-primary--ready:hover:not(:disabled) {
          ...
          color:#1e1e20 !important;
          border-color:var(--festag-btn-ready-border-hover, rgba(30, 30, 32, 0.12)) !important;
          outline:none !important;
          box-shadow:none !important;
        }
        ...
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary.al-btn-primary--ready:active:not(:disabled) {
          ...
          color:#1e1e20 !important;
          border-color:var(--festag-btn-ready-border-active, rgba(30, 30, 32, 0.08)) !important;
          outline:none !important;
          box-shadow:none !important;
        }
        ...
        /* Idle Weiter — no focus chrome (disabled / not ready). */
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary:not(.al-btn-primary--ready):focus,
        .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary:not(.al-btn-primary--ready):focus-visible {
          outline:none !important;
          border:1px solid rgba(30, 30, 32, 0.04) !important;
          box-shadow:none !important;
        }
        /* Light Google — Festag primary blue. */
        ...
        .al-btn-google:active:not(:disabled) {
          ...
          border-color:var(--festag-btn-dark-border-active, rgba(30, 30, 32, 0.10)) !important;
          outline:none;
          box-shadow:none;
        }
        ...
        .al-google-icon {
          ...
          display:block;
          object-fit:contain;
          opacity:var(--festag-oauth-icon-opacity, 0.42);
        ...
        .al-btn-google:hover:not(:disabled) .al-google-icon,
        .al-btn-google:focus-visible:not(:disabled) .al-google-icon,
        .al-btn-google:active:not(:disabled) .al-google-icon,
        .al-btn-apple:hover:not(:disabled) .al-apple-icon,
        .al-btn-apple:focus-visible:not(:disabled) .al-apple-icon,
        .al-btn-apple:active:not(:disabled) .al-apple-icon {
          opacity:var(--festag-oauth-icon-opacity-hover, 0.82);
        }
        ...
        .al-input {
          width:100%;
          /* Only control allowed taller than CTAs — +1px. */
          ...
          /* 2px hairline always — focus/filled only change color (no outer ring). */
          border:var(--festag-input-border-width, 2px) solid var(--festag-input-border, rgba(30,30,32,0.15)) !important;
          ...
          -webkit-text-size-adjust:100%;
          text-size-adjust:100%;
          /* Color only — width stays on tokens so L/R edges never reflow/clip. */
        ...
        /* Empty hover / filled — hairline stays. Focus = accent color only (never drop stroke). */
        .al-input:hover,
        .al-input:active {
          background-color:var(--festag-input-fill-focus, transparent);
          background-image:none;
          border:var(--festag-input-border-width, 2px) solid var(--festag-input-border-hover, rgba(30,30,32,0.20)) !important;
          outline:none !important;
          outline-offset:0 !important;
          box-shadow:none;
        }
        ...
        .al-input-shell.has-value .al-input {
          background-color:var(--festag-input-fill-focus, transparent);
          background-image:none;
          border:var(--festag-input-border-width-filled, 2px) solid var(--festag-input-border-filled, #5B647D) !important;
          outline:none !important;
          outline-offset:0 !important;
          box-shadow:none;
        }
        /* Include .has-value / :not(:placeholder-shown) so filled never beats focus. */
        .al-input:focus,
        .al-input:focus-visible,
        .al-input:not(:placeholder-shown):focus,
        .al-input:not(:placeholder-shown):focus-visible,
        .al-input-shell.has-value .al-input:focus,
        ...
        /* Hard-lock light fills — transparent stroke fields (Intent-style). CTAs stay white. */
        ...
        .al-root:not([data-theme="dark"]) .al-input:active {
          background:transparent !important;
          background-color:transparent !important;
          border-width:var(--festag-input-border-width, 2px) !important;
          border-style:solid !important;
        ...
        .al-root:not([data-theme="dark"]) .al-input-shell.has-value .al-input {
          ...
          border-style:solid !important;
          border-color:var(--festag-input-border-filled, #5B647D) !important;
          box-shadow:none !important;
        }
        .al-root:not([data-theme="dark"]) .al-input:focus,
        .al-root:not([data-theme="dark"]) .al-input:focus-visible,
        .al-root:not([data-theme="dark"]) .al-input:not(:placeholder-shown):focus,
        .al-root:not([data-theme="dark"]) .al-input:not(:placeholder-shown):focus-visible,
        .al-root:not([data-theme="dark"]) .al-input-shell.has-value .al-input:focus,
        ...
        /* Chrome autofill — ivory inset so field reads transparent on canvas. */
        ...
        /* Caret / selection — lighter primary stroke #7E889F */
        .al-root ::selection {
        ...
        .atm.al-theme-icon--header { display:none; }
        .atm.al-theme-icon--footer { display:inline-flex; }
        .al-footer-sep {
          display:inline-flex;
          align-items:center;
          justify-content:center;
        ...
        /* Signup: already-registered — H1 becomes the sentence, form soft-dims */
        .al-hero-copy--status {
          display:flex;
          flex-direction:column;
          align-items:flex-start;
          gap:18px;
          animation: alStatusHeroIn .34s cubic-bezier(.16,1,.3,1) both;
        }
        @keyframes alStatusHeroIn {
          from { opacity:0; transform:translateY(4px); }
          to { opacity:1; transform:translateY(0); }
        }
        .al-title--status {
        ...
        /* Dark mode — Primary Dusk OS canvas */
        .al-root[data-theme="dark"] {
          background:
            radial-gradient(ellipse 100% 52% at 50% -6%, rgba(91, 100, 125, 0.14), transparent 58%),
            radial-gradient(ellipse 95% 50% at 50% 108%, rgba(91, 100, 125, 0.12), rgba(70, 78, 102, 0.045) 48%, transparent 74%),
        ...
        .al-root[data-theme="dark"] .al-btn-apple {
          background:var(--festag-btn-dark-bg, transparent);
          color:var(--festag-btn-dark-fg, rgba(228,228,234,0.62));
          border:1px solid var(--festag-btn-dark-border, rgba(255,255,255,0.10)) !important;
          box-shadow:none;
        }
        /* OAuth — active, not disabled: brighter ink + icons. */
        .al-root[data-theme="dark"] .al-btn-google,
        .al-root[data-theme="dark"] .al-btn-apple {
          color:var(--festag-btn-oauth-fg, rgba(232,234,240,0.90));
        }
        /* Ready — warm bone after valid email. */
        .al-root[data-theme="dark"] .al-btn-primary.al-btn-primary--ready {
          background:var(--festag-btn-ready-bg, #EBE8E3) !important;
          background-color:var(--festag-btn-ready-bg, #EBE8E3) !important;
          color:var(--festag-btn-ready-fg, #1A1917) !important;
          border:1px solid transparent !important;
          box-shadow:none !important;
        }
        ...
        .al-root[data-theme="dark"] .al-btn-primary.al-btn-primary--ready:focus-visible:not(:disabled) {
          background:var(--festag-btn-ready-bg-hover, #DDD9D2) !important;
          background-color:var(--festag-btn-ready-bg-hover, #DDD9D2) !important;
          color:var(--festag-btn-ready-fg, #1A1917) !important;
          box-shadow:none !important;
        }
        .al-root[data-theme="dark"] .al-btn-primary.al-btn-primary--ready:active:not(:disabled) {
          background:var(--festag-btn-ready-bg-active, #D0CBC3) !important;
          color:var(--festag-btn-ready-fg, #1A1917) !important;
          box-shadow:none !important;
        }
        ...
        /* OAuth — soft lift + bright ink so they read as active CTAs. */
        .al-root[data-theme="dark"] .al-btn-google,
        .al-root[data-theme="dark"] .al-btn-apple {
          background:var(--festag-btn-oauth-bg, rgba(255,255,255,0.055)) !important;
          color:var(--festag-btn-oauth-fg, rgba(245,245,247,0.94)) !important;
          border:1px solid var(--festag-btn-oauth-border, rgba(255,255,255,0.16)) !important;
          box-shadow:none !important;
        }
        .al-root[data-theme="dark"] .al-btn-google:hover:not(:disabled),
        .al-root[data-theme="dark"] .al-btn-google:focus-visible:not(:disabled),
        .al-root[data-theme="dark"] .al-btn-apple:hover:not(:disabled) {
          background:var(--festag-btn-oauth-bg-hover, rgba(255,255,255,0.08)) !important;
          color:var(--festag-btn-oauth-fg-hover, rgba(255,255,255,1)) !important;
          border-color:var(--festag-btn-oauth-border-hover, rgba(255,255,255,0.22)) !important;
          box-shadow:none !important;
        }
        .al-root[data-theme="dark"] .al-btn-primary:hover:not(:disabled):not(.al-btn-primary--ready),
        .al-root[data-theme="dark"] .al-btn-ghost:hover:not(:disabled) {
          background:var(--festag-btn-dark-bg-hover, rgba(255,255,255,0.04)) !important;
          color:var(--festag-btn-dark-fg-hover, rgba(232,234,240,0.92)) !important;
          border-color:var(--festag-btn-dark-border-hover, rgba(255,255,255,0.16)) !important;
          box-shadow:none !important;
        }
        /* Focus only — thicker stroke (inputs + hairline CTAs). */
        .al-root[data-theme="dark"] .al-btn-apple:focus:not(:disabled),
        .al-root[data-theme="dark"] .al-btn-apple:focus-visible:not(:disabled),
        .al-root[data-theme="dark"] .al-btn-primary:focus:not(:disabled),
        ...
        .al-root[data-theme="dark"] .al-btn-ghost:focus-visible:not(:disabled) {
          border-width:var(--festag-btn-border-width-focus, 2px) !important;
          border-style:solid !important;
          border-color:var(--festag-btn-border-focus, var(--festag-input-border-focus, #5B647D)) !important;
          outline:none !important;
          box-shadow:none !important;
        }
        .al-root[data-theme="dark"] .al-btn-google:active:not(:disabled),
        .al-root[data-theme="dark"] .al-btn-apple:active:not(:disabled) {
          background:var(--festag-btn-oauth-bg-active, rgba(255,255,255,0.10)) !important;
          color:var(--festag-btn-oauth-fg-hover, rgba(255,255,255,1)) !important;
          border-color:var(--festag-btn-oauth-border, rgba(255,255,255,0.16)) !important;
          box-shadow:none !important;
        }
        .al-root[data-theme="dark"] .al-btn-primary:active:not(:disabled):not(.al-btn-primary--ready),
        .al-root[data-theme="dark"] .al-btn-ghost:active:not(:disabled) {
          background:var(--festag-btn-dark-bg-active, rgba(255,255,255,0.06)) !important;
          color:var(--festag-btn-dark-fg-active, rgba(232,234,240,0.96)) !important;
          border-color:var(--festag-btn-dark-border-active, rgba(255,255,255,0.12)) !important;
          box-shadow:none !important;
        }
        ...
        /* Dark auth inputs — transparent fill always; stroke only (thicker hairline). */
        .al-root[data-theme="dark"] .al-input {
          ...
          border:var(--festag-input-border-width, 2px) solid var(--festag-input-border, rgba(255,255,255,0.16)) !important;
          box-shadow:none;
          caret-color:var(--festag-input-caret, ${AUTH_INPUT_CARET_DARK});
          border-radius:var(--festag-input-radius, 8px);
        ...
        .al-root[data-theme="dark"] .al-input:active {
          ...
          background-color:transparent !important;
          background-image:none !important;
          border:var(--festag-input-border-width, 2px) solid var(--festag-input-border-hover, rgba(255,255,255,0.22)) !important;
          box-shadow:none;
          outline:none;
        }
        .al-root[data-theme="dark"] .al-input:not(:placeholder-shown),
        .al-root[data-theme="dark"] .al-input-shell.has-value .al-input {
          background:transparent !important;
          background-color:transparent !important;
          background-image:none !important;
          border:var(--festag-input-border-width-filled, 2px) solid var(--festag-input-border-filled, #5B647D) !important;
        ...
        .al-root[data-theme="dark"] .al-input:not(:placeholder-shown):focus,
        .al-root[data-theme="dark"] .al-input:not(:placeholder-shown):focus-visible,
        .al-root[data-theme="dark"] .al-input-shell.has-value .al-input:focus,
        .al-root[data-theme="dark"] .al-input-shell.has-value .al-input:focus-visible {
          background:transparent !important;
          background-color:transparent !important;
          background-image:none !important;
          border:var(--festag-input-border-width-focus, 2px) solid var(--festag-input-border-focus, #5B647D) !important;
        ...
        /* Dark autofill — canvas-matched inset so Chrome cannot paint a fill plate. */
        ...
        .al-root[data-theme="dark"] .al-input:-webkit-autofill:active {
          border-width:var(--festag-input-border-width, 2px) !important;
          border-color:var(--festag-input-border-hover, rgba(255,255,255,0.22)) !important;
          -webkit-box-shadow:0 0 0 1000px ${AUTH_INPUT_AUTOFILL_DARK} inset !important;
          box-shadow:0 0 0 1000px ${AUTH_INPUT_AUTOFILL_DARK} inset !important;
        }
        .al-root[data-theme="dark"] .al-input:-webkit-autofill:focus {
        ...
        .al-root[data-theme="dark"] .al-support-modal {
          background:var(--festag-black-popup, #1A1917);
        ...
        @media (min-width: 769px) {
          ...
          /* Single-column auth — optically centered; no footer chrome. */
          ...
          /* Typography is the hero — large, elegant, relaxed. */
          .al-hero-copy .al-title.al-title-display,
          .al-hero-copy .al-hero-gray,
          .al-title,
          .al-title-display,
          ...
          .al-wordmark:hover .al-wordmark-img {
            opacity:0.92;
          }
          ...
          .al-root--centered .al-desktop-left {
            ...
            width:100%;
            max-width:none;
            padding:clamp(24px, 5vh, 56px) var(--al-col-pad);
          }
          ...
          .al-desktop-left {
            ...
            align-items:center;
            width:100%;
            padding:clamp(32px, 6vh, 64px) var(--al-col-pad);
            background:transparent;
          }
          ...
          /* Vertical rhythm — no flex gap; /Benutzer uses secondary margin-top only when mounted. */
          .al-signin-head {
            margin-bottom:var(--al-desktop-hero-gap, 18px);
            gap:0;
          }
          ...
          .al-divider {
            ...
            color:var(--al-text-muted-soft, #6B7385);
            opacity:0.72;
          }
          .al-divider::before,
          .al-divider::after {
          ...
          .al-root:not([data-theme="dark"]) .al-divider::before,
          .al-root:not([data-theme="dark"]) .al-divider::after {
          ...
          .al-footer-meta {
            ...
            z-index:20;
            margin:0;
            padding:22px 40px max(28px, env(safe-area-inset-bottom));
            width:100%;
            max-width:none;
            display:flex;
            flex-direction:row;
        ...
        @media (max-width: 768px) {
          .al-root,
          .al-root[data-theme="dark"],
          .al-root[data-theme="light"],
          .al-root[data-theme="read"] {
            /* Shared pre-dashboard mobile chrome — same column + type as Dev login.
             * Must beat desktop dark/light token blocks (higher specificity). */
            ${AUTH_MOBILE_CHROME_VARS}
          }
          ...
          .al-header {
             ...
             * Tighter than form column so logo / icons sit further out. */
            --al-header-chrome-gutter:16px;
            padding:max(10px, calc(env(safe-area-inset-top, 0px) + 8px)) var(--al-header-chrome-gutter) 10px;
            min-height:44px;
            flex-wrap:nowrap;
            flex-shrink:0;
            width:100%;
            max-width:none;
            box-sizing:border-box;
            /* Transparent — continuous elevated canvas. */
            background:transparent;
            border-radius:0 !important;
            justify-content:space-between;
            align-items:center;
          ...
          /* Beat .al-root--centered .al-header { 32px } — header edge only; footer stays 32. */
          .al-root--centered .al-header {
            padding-left:var(--al-header-chrome-gutter, 16px);
            padding-right:var(--al-header-chrome-gutter, 16px);
          ...
          /* Mark — slightly larger on mobile */
          .al-wordmark {
            width:36px;
            height:36px;
            padding:0;
          ...
          .atm.al-theme-icon--header { display:none !important; }
          .atm.al-theme-icon--footer { display:inline-flex !important; }
          .al-main {
            flex:1;
            min-height:0;
            overflow:hidden;
            ...
            align-items:stretch;
            justify-content:center;
            padding:8px var(--al-col-pad) max(24px, env(safe-area-inset-bottom));
          }
          .al-container:has(.al-agreements--mobile-dock) .al-main {
            padding-bottom:12px;
          }
          /* Mobile auth — canvas SSOT: optically centered between header + bottom. */
          .al-root[data-auth-mode="login"] .al-main,
          .al-root[data-auth-mode="signup"] .al-main {
            justify-content:center;
            align-items:center;
            /* Same 28px side gutter as canvas contentArea. */
            padding-left:28px;
            padding-right:28px;
            padding-top:16px;
          ...
          .al-auth-switch .al-account-hint-link {
            display:inline !important;
            text-align:left;
          }
          .al-root[data-auth-mode="signup"] .al-content > .al-account-hint,
          .al-root[data-auth-mode="signup"] .al-content > .al-account-hint-link {
            display:none !important;
          }
          .al-footer-legal--mobile {
            display:inline-flex !important;
          ...
          .al-root[data-auth-mode="signup"] .al-signin {
            flex:0 0 auto;
            width:100%;
            max-width:var(--al-panel-width, 380px);
            height:auto;
            max-height:none;
            justify-content:flex-start;
            /* No fake bottom pad — that yanked the block toward the status bar. */
            padding-bottom:0;
            margin-inline:auto;
          }
          .al-root[data-auth-mode="login"] .al-sheet-body,
          ...
          /* Keep mode sentence in footer dock on mobile (under-form AGB is hidden). */
          .al-root[data-auth-mode="signup"] .al-agreements--under-form .al-account-hint {
            display:none !important;
          }
          .al-root[data-auth-mode="login"] .al-agreements--under-form .al-account-hint {
            display:none !important;
          }
          .al-agreements--mobile-dock {
            display:flex;
          ...
          .al-root[data-auth-mode="signup"] .al-footer-meta {
            ...
            align-items:stretch;
            gap:0;
            padding:10px var(--al-chrome-gutter) max(14px, env(safe-area-inset-bottom));
          }
          .al-desktop-stage,
          .al-desktop-stage--centered,
          .al-desktop-left {
          ...
          .al-root[data-auth-mode="signup"] .al-signin-head {
            flex:0 0 auto;
            /* Title only — no empty /Benutzer slot (cold login / Code ohne Name). */
            min-height:var(--al-hero-display-lh, 31px);
          ...
          .al-root[data-auth-mode="login"] .al-signin-head--has-user,
          .al-root[data-auth-mode="signup"] .al-signin-head--has-user {
            min-height:calc(var(--al-hero-display-lh, 31px) + var(--al-hero-name-lh, 31px));
          }
          ...
          .al-root[data-auth-mode="login"] .al-hero-copy button.auth-ws-path--edit,
          ...
          .al-root[data-auth-mode="login"] .al-hero-copy .auth-ws-path-wrap,
          .al-root[data-auth-mode="signup"] .al-hero-copy .auth-ws-path-wrap,
          .al-root[data-auth-mode="signup"] .al-hero-copy .al-ws-name-line {
            display:flex;
            justify-content:flex-start;
          }
          .al-root[data-auth-mode="login"],
          .al-root[data-auth-mode="signup"] {
            /* Same as onboarding H1 size — lh tall enough for descenders. */
            --al-hero-display-size:29px;
            --al-hero-display-lh:36px;
            --al-hero-name-size:29px;
            --al-hero-name-lh:36px;
          ...
          /* Status only takes space while visible — empty slot collapses so CTAs return. */
          .al-root[data-auth-mode="signup"] .al-ws-status-slot {
            display:flex;
            align-items:center;
            min-height:0;
            margin-top:10px;
          ...
          .al-root[data-auth-mode="signup"] .al-ws-status-slot:not(:has(.al-ws-status)) {
            display:none;
            margin-top:0;
            min-height:0;
          }
          .al-root[data-auth-mode="signup"] .al-signin-head--has-user {
            /* Register always has the /Benutzer line under the title. */
            min-height:calc(var(--al-hero-display-lh, 31px) + var(--al-hero-name-lh, 31px));
            margin-bottom:18px !important;
          }
          ...
          .al-root[data-auth-mode="login"] h1.al-title,
          .al-root[data-auth-mode="login"] h1.al-title.al-title-display,
          .al-root[data-auth-mode="login"] .al-title,
          .al-root[data-auth-mode="login"] .al-title-nowrap,
          .al-root[data-auth-mode="login"] .al-hero-copy .al-title.al-title-display,
          .al-root[data-auth-mode="signup"] h1.al-title,
          .al-root[data-auth-mode="signup"] h1.al-title.al-title-display,
          ...
          .al-root[data-auth-mode="login"] .al-hero-copy .al-hero-gray,
          .al-root[data-auth-mode="login"] .al-hero-copy .auth-ws-path,
          .al-root[data-auth-mode="login"] .al-hero-copy button.auth-ws-path--tap,
          .al-root[data-auth-mode="login"] .al-hero-copy button.auth-ws-path--edit,
          .al-root[data-auth-mode="signup"] .al-hero-copy .al-hero-gray,
          .al-root[data-auth-mode="signup"] .al-hero-copy .al-ws-name-input,
          .al-root[data-auth-mode="signup"] .al-hero-copy .al-ws-path,
          .al-root[data-auth-mode="signup"] .al-hero-copy button.al-ws-path--editable,
          .al-root[data-auth-mode="signup"] .al-hero-copy .auth-ws-path,
          ...
          /* Gap under H1 — on the secondary row, not the path wrap (badge alignment). */
          .al-hero-copy .al-hero-secondary {
            margin-top:4px;
          }
          .al-hero-copy .al-ws-path,
          .al-hero-copy button.al-ws-path--editable,
          ...
          /* Mobile — full-width CTAs, taller hit area, calm label type. */
          .al-btn {
            width:100%;
            max-width:none;
            align-self:stretch;
          ...
          /* Light: white CTAs on elevated cool. */
          ...
          .al-method-group .al-input-shell,
          .al-method-group .al-input,
          .al-method-group .al-email-feedback-host,
          .al-method-group .al-hint {
            width:100%;
            max-width:100%;
            align-self:stretch;
          }
          ...
          /* Light mobile — idle Weiter stays quiet; ready/Apple/SSO white plates. */
          .al-root:not([data-theme="dark"]) .al-btn.al-btn-primary:not(.al-btn-primary--ready) {
            background:transparent !important;
            color:var(--al-text-muted, #8891a0) !important;
            border:1px solid rgba(30, 30, 32, 0.04) !important;
          ...
          .al-root[data-theme="dark"] .al-btn.al-btn-primary.al-under-cta-switch {
            background:var(--festag-btn-dark-bg, transparent) !important;
            color:var(--festag-btn-dark-fg, rgba(228,228,234,0.62)) !important;
            border:1px solid var(--festag-btn-dark-border, rgba(255,255,255,0.10)) !important;
            box-shadow:none !important;
          }
          .al-root[data-theme="dark"] .al-btn.al-btn-apple,
          ...
          .al-root[data-theme="dark"] .al-btn.al-btn-primary:hover:not(:disabled):not(.al-btn-primary--ready),
          ...
          .al-root[data-theme="dark"] .al-btn.al-btn-primary:active:not(:disabled):not(.al-btn-primary--ready),
        ...
        @media (max-width: 768px) and (max-height: 670px) {
          ...
          .al-footer-meta {
            padding:8px var(--al-chrome-gutter) max(12px, env(safe-area-inset-bottom));
            gap:8px;
            justify-content:flex-start;
          }
        ...
        @media (min-width: 769px) {
          ...
          .al-root[data-auth-step="codeEntry"] .al-hero-copy,
          .al-root[data-auth-step="sso"] .al-hero-copy {
            overflow:visible !important;
          }
          .al-root[data-auth-step="codeEntry"] .al-hero-secondary,
          .al-root[data-auth-step="sso"] .al-hero-secondary {
            display:block !important;
            visibility:visible !important;
            opacity:1 !important;
            transform:none !important;
          ...
          .al-root[data-auth-step="codeEntry"] .al-ws-path-check-row button.auth-ws-path--edit {
            font-size:var(--al-hero-name-size, 29px) !important;
            line-height:var(--al-hero-name-lh, 36px) !important;
            letter-spacing:var(--auth-tracking-display, 0.006em) !important;
            color:#8891a0 !important;
          }
        ...
        /* ── Mobile OTP / SSO — same H1 + /Benutzer as login/register ── */
        @media (max-width: 768px) {
          .al-root[data-auth-step="codeEntry"],
          .al-root[data-auth-step="sso"] {
            --al-hero-display-size:29px;
            --al-hero-display-lh:36px;
            --al-hero-name-size:29px;
            --al-hero-name-lh:36px;
          ...
          .al-root[data-auth-step="sso"] .al-signin {
            justify-content:center;
            padding-bottom:max(28px, env(safe-area-inset-bottom));
          }
          ...
          .al-root[data-auth-step="codeEntry"] .al-glassy-hero,
          .al-root[data-auth-step="sso"] .al-hero-copy .al-title.al-title-display,
          .al-root[data-auth-step="sso"] .al-glassy-hero {
            font-size:var(--al-hero-display-size) !important;
            line-height:var(--al-hero-display-lh) !important;
            letter-spacing:var(--auth-tracking-display, 0.006em) !important;
          ...
          .al-root[data-auth-step="sso"] .al-hero-secondary {
            ...
            filter:none !important;
            animation:none !important;
            min-height:var(--al-hero-name-lh, 36px);
            overflow:visible !important;
          }
          .al-root[data-auth-step="codeEntry"] .al-ws-path-check-row,
          .al-root[data-auth-step="sso"] .al-ws-path-check-row {
            display:inline-flex !important;
          ...
          .al-root[data-auth-step="codeEntry"] .al-ws-path-check-row .auth-ws-path,
          .al-root[data-auth-step="codeEntry"] .al-ws-path-check-row .auth-ws-path-wrap,
          .al-root[data-auth-step="codeEntry"] .al-ws-path-check-row button.auth-ws-path--tap,
          .al-root[data-auth-step="codeEntry"] .al-ws-path-check-row button.auth-ws-path--edit,
          .al-root[data-auth-step="sso"] .al-ws-path-check-row .auth-ws-path,
          .al-root[data-auth-step="sso"] .al-ws-path-check-row .auth-ws-path-wrap,
          .al-root[data-auth-step="sso"] .al-ws-path-check-row button.auth-ws-path--tap,
          .al-root[data-auth-step="sso"] .al-ws-path-check-row button.auth-ws-path--edit {
            width:auto !important;
            font-size:var(--al-hero-name-size, 29px) !important;
            line-height:var(--al-hero-name-lh, 36px) !important;
            letter-spacing:var(--auth-tracking-display, 0.006em) !important;
          ...
          .al-root[data-auth-step="sso"] .al-ws-ok-badge {
            width:18px;
            height:18px;
          }
          .al-root[data-auth-step="codeEntry"] .al-signin-stack--code {
