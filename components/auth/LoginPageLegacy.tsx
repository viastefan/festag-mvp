/**
 * LEGACY LOGIN — preserved for rollback.
 *
 * To restore the previous login UI, replace `app/login/page.tsx` with:
 *   export { default } from '@/components/auth/LoginPageLegacy'
 *
 * Or copy this file back to `app/login/page.tsx`.
 */
'use client'
...
export default function LoginPageLegacy() {
  ...
  const legal = (
    <div className="log-legal">
      ...
      <a className="log-dev" href="/dev" onClick={e => { e.preventDefault(); navigateWithFade('/dev/login') }}>Dev</a>
    </div>
  )
    ...
    <main className={`log-root${pageExiting ? ' exiting' : ''}`} data-theme={theme}>
      <style>{`
        *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
        .log-root { min-height:100dvh; width:100%; --log-text-muted:#8e8e93; --log-text-muted-soft:#aeaeb2; font-family:'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif; -webkit-font-smoothing:antialiased; text-rendering:geometricPrecision; transition: opacity 0.16s linear; }
        .log-root[data-theme="dark"] { --log-text-muted:rgba(235,235,245,0.6); --log-text-muted-soft:rgba(235,235,245,0.4); }
        ...
        .log-back { font-family:'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif; font-size:13px; font-weight:400 !important; color:var(--log-text-muted); background:none; border:none; cursor:pointer; text-align:center; letter-spacing:0.26px; line-height:20px; transition:color .15s; padding:4px; }
        .log-back:hover { color:#202532; }
        .log-link-action { font-family:'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif; font-size:13px; font-weight:400 !important; color:var(--log-text-muted); background:none; border:none; cursor:pointer; text-align:center; letter-spacing:0.26px; line-height:20px; transition:color .15s; padding:4px; }
        ...
        .log-support-note { margin:-4px 0 0; font-family:'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif; font-size:12.5px; line-height:18px; font-weight:400 !important; color:var(--log-text-muted); text-align:center; letter-spacing:var(--festag-tracking-small, 0.015em); }
        ...
        .log-newest-hint { margin:-4px 0 -2px; font-family:'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif; font-size:12px; line-height:1.5; font-weight:400 !important; color:var(--log-text-muted); text-align:center; letter-spacing:var(--festag-tracking-small, 0.015em); padding:8px 12px; background:rgba(91,100,125,0.05); border:1px solid rgba(91,100,125,0.10); border-radius:10px; }
        ...
        .log-support-head p { margin:5px 0 0; color:var(--log-text-muted); font-size:12.5px; line-height:18px; font-weight:400 !important; letter-spacing:var(--festag-tracking-small, 0.015em); }
        ...
        .log-legal-text { font-family:'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif; font-size:13px; font-weight:400 !important; line-height:20px; letter-spacing:var(--festag-tracking-small, 0.015em); color:var(--log-text-muted); }
        ...
        .log-dev { font-family:'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif; font-size:13px; font-weight:400 !important; line-height:20px; letter-spacing:var(--festag-tracking-small, 0.015em); color:var(--log-text-muted); text-decoration:none; text-align:center; display:block; transition:color .3s; }
        ...
        .log-root[data-theme="dark"] .log-ssl-badge { color: var(--log-text-muted); }
        .log-region-note {
          margin: 0;
          text-align: right;
          font-family: 'Aeonik', Inter, -apple-system, BlinkMacSystemFont, 'SF Pro Text', 'Segoe UI', sans-serif;
        ...
        .log-root[data-theme="dark"] .log-hint { color:var(--log-text-muted); }
        .log-root[data-theme="dark"] .log-legal-text { color:var(--log-text-muted); }
        .log-root[data-theme="dark"] .log-legal-text a { color:#e8ebf1; }
        .log-root[data-theme="dark"] .log-legal-text a:hover { color:#b9c4d6; }
        .log-root[data-theme="dark"] .log-dev { color:var(--log-text-muted); }
        .log-root[data-theme="dark"] .log-dev:hover { color:#e8ebf1; }
        .log-root[data-theme="dark"] .log-back { color:var(--log-text-muted); }
        .log-root[data-theme="dark"] .log-back:hover { color:#e8ebf1; }
        .log-root[data-theme="dark"] .log-link-action { color:var(--log-text-muted); }
        .log-root[data-theme="dark"] .log-link-action:hover { color:#e8ebf1; }
        .log-root[data-theme="dark"] .log-sent-info { color:var(--log-text-muted); }
