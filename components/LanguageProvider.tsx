...
const TRANSLATIONS: Record<string, string> = {
  ...
  'Über dich': 'About you',
  'Kurze Bio': 'Short bio',
  'Ein bis zwei Sätze über dich. Veyra nutzt das als Kontext, wenn neue Mitwirkende dazukommen.': 'One or two sentences about you. Veyra uses this as context when new collaborators join.',
  ...
  'Zeitzone': 'Time zone',
  'Beeinflusst, wann Veyra Daily-Notes und tägliche Briefings ausspielt.': 'Controls when Veyra sends daily notes and daily briefings.',
  'Sprache': 'Language',
  'In welcher Sprache Veyra mit dir spricht.': 'The language Veyra uses with you.',
  'Deutsch': 'German',
  'English': 'English',
  'Profilvollständigkeit': 'Profile completeness',
  'Ein vollständiges Profil hilft Veyra bei Zuordnung, Kommunikation und Projektkontext.': 'A complete profile helps Veyra with assignment, communication, and project context.',
  'Status': 'Status',
  ...
  'Spielt die kurze Tour ab, die Dashboard, Projekte, Statusabfrage, Veyra und Teams erklärt. Bestehende Daten bleiben unberührt.': 'Replays the short tour explaining dashboard, projects, status check, Veyra, and teams. Existing data stays untouched.',
  'Tour starten': 'Start tour',
  'Konto löschen': 'Delete account',
  'Beendet deinen Festag-Zugang endgültig. Workspaces, Projekte, Briefings, Inbox-Items und Veyra-Memory werden mitgelöscht. Diese Aktion ist nicht rückgängig zu machen.': 'Permanently ends your Festag access. Workspaces, projects, briefings, inbox items, and Veyra memory are deleted as well. This action cannot be undone.',
  'Bitte erneut anmelden.': 'Please sign in again.',

  // Notifications and connected accounts
  'E-Mail-Benachrichtigungen': 'Email notifications',
  'Veyra-Updates, Aufgaben, Projektbriefings.': 'Veyra updates, tasks, project briefings.',
  ...
  'Kurze Beschreibung, die Veyra für Kontext nutzt.': 'Short description that Veyra uses as context.',
  ...
  'Veyra Briefings sind das tägliche Kontrollsystem für Softwareprojekte. API-basierte Voice Reports werden separat kalkuliert; ein ChatGPT-Abo deckt die Festag-App-API nicht automatisch ab.': 'Veyra briefings are the daily control system for software projects. API-based voice reports are calculated separately; a ChatGPT subscription does not automatically cover the Festag app API.',
