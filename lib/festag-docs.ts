...
export const docsCategories: Array<{ title: FestagDocSection | 'Best Practices' | 'Hilfe & Support'; description: string }> = [
  ...
  { title: 'Veyra AI', description: 'Wie Veyra Informationen sortiert, bewertet und verdichtet.' },
...
export const festagDocsArticles: FestagDocArticle[] = [
  richArticle('Veyra AI', 'Vom Dev-Update zur ruhigen Client-Lage', 'tagro-statusbriefing',
    'Wie der tägliche 16:00-Loop funktioniert, was Veyra aus Dev-Updates baut und warum Reporting bei Festag operative Steuerung ist, nicht Doku.',
    ['Veyra', 'Statusbriefing', 'Dev-Updates', 'Client-Lage', 'Reports'],
    [
      { type: 'lead', text: 'Festag trennt interne Arbeitsrealität von client-fähiger Lage. Veyra sitzt dazwischen: sie liest Arbeitssignale, prüft Relevanz und formuliert daraus verständliche Statusberichte.' },
      { type: 'mono', text: [
        '16:00 Berlin',
        '   |',
        '   v',
        ...
        '   |',
        '   v',
        'dev_daily_prompts (eine Karte pro Developer + Projekt + Tag)',
        '   |',
        '   v',
      ...
      { type: 'heading', level: 2, text: 'Warum diese Logik wichtig ist', id: 'warum' },
      { type: 'paragraph', text: 'Der Kunde will nicht jeden Commit, jede interne Rückfrage und jede technische Nuance lesen. Er will wissen, ob das Projekt ruhig läuft, ob etwas blockiert ist, ob eine Entscheidung gebraucht wird und was als Nächstes passiert.' },
      { type: 'paragraph', text: 'Genau dafür sitzt Veyra zwischen Ausführung und Client-Sicht. Die Arbeitsrealität bleibt vollständig dokumentiert, aber die Client-Kommunikation wird bewusst klar, kurz und professionell.' },

      { type: 'heading', level: 2, text: 'Der tägliche Status ist kein Chat', id: 'kein-chat' },
      { type: 'paragraph', text: 'Das Developer-Update ist bewusst klein: ein Satz, ein Fortschritt, ein Blocker oder ein Hinweis. Veyra sammelt diese Signale über 24 Stunden und macht daraus eine Lage, die im Dashboard, in Statusberichten und optional als Audio verfügbar ist.' },
      { type: 'list', items: [
        'Was wurde seit dem letzten Bericht tatsächlich bewegt?',
        'Welche Risiken oder Blocker brauchen Aufmerksamkeit?',
        'Welche Entscheidung muss vom Client oder Projektverantwortlichen kommen?',
        'Welche neue Aufgabe sollte aus dem Bericht entstehen?',
        'Welche Formulierung ist client-safe und nicht unnötig technisch?',
      ] },

      { type: 'heading', level: 2, text: 'Datenmodell als Trust-Layer', id: 'datenmodell' },
      { type: 'paragraph', text: 'Statusberichte dürfen nicht aus dünner Luft entstehen. Der Bericht muss auf echten Developer-Updates, Aufgaben, Entscheidungen und optionalen Nachweisen basieren. Deshalb trennt Festag interne Signale von sichtbaren Client-Berichten.' },
      { type: 'mono', text: [
        'developer_updates',
        '  project_id',
        '  developer_id',
      ...
      { type: 'paragraph', text: 'Veyra ist kein Überwachungswerkzeug. Es ist eine Übersetzungsschicht. Der Developer arbeitet intern, Veyra prüft und verdichtet, und der Client bekommt nur die klare Lage: Fortschritt, Risiko, Entscheidung, nächster Schritt.' },
      { type: 'mono', text: [
        'Dev Panel                 Veyra Layer                  Client Panel',
        '---------                 -----------                  ------------',
      ...
      { type: 'heading', level: 2, text: 'Wenn aus Bericht Arbeit wird', id: 'lebenszyklus' },
      { type: 'paragraph', text: 'Ein Statusbericht ist nicht das Ende der Arbeit. Wenn Veyra einen offenen Punkt erkennt, kann daraus eine Aufgabe, ein Risiko, eine Entscheidung oder ein Projektbriefing entstehen. So wird Reporting nicht nur Dokumentation, sondern operative Steuerung.' },
      { type: 'list', ordered: true, items: [
        'Dev gibt tägliches Update ab.',
        'Veyra baut daraus eine verständliche Lage.',
        'Client liest oder hört den Bericht.',
        'Risiken und Entscheidungen werden zu Aktionspunkten.',
        'Aus offenen Punkten können neue Tasks entstehen.',
      ] },
      { type: 'quote', text: 'Zielbild: Der Client öffnet Festag, hört ein 30- bis 60-sekündiges Veyra-Briefing und versteht sofort, was passiert ist, was blockiert ist und worauf er achten muss.' },
    ], true, '6 Min.'),
  article('Erste Schritte', 'Was ist Festag?', 'was-ist-festag',
    ...
    {
      overview: 'Festag bündelt Projekte, Aufgaben, Statusabfragen und Veyra-Briefings in einer ruhigen Arbeitsoberfläche.',
      explanation: [
  ...
  article('Erste Schritte', 'Schnellstart mit Festag', 'schnellstart-mit-festag',
    ...
    ['Start', 'Onboarding', 'Projektanlage'],
    {
      ...
      example: 'Ein neues Website-Projekt startet mit Titel, Ziel, nächstem Meilenstein und zwei Mitwirkenden. Danach kann Veyra erste nächste Schritte ableiten.',
  ...
  article('Erste Schritte', 'Das Dashboard verstehen', 'dashboard-verstehen',
    'Wie Projekte, Aufgaben, Statusmeldungen und Veyra-Hinweise zusammenlaufen.',
    ['Dashboard', 'Statusabfrage', 'Überblick'],
    {
      ...
      explanation: [
        ...
        'Veyra verdichtet Aufgaben, Projektstatus und Berichte zu einer verständlichen Lage, die schnell gelesen oder gehört werden kann.',
      ],
  ...
  article('Erste Schritte', 'Die wichtigsten Bereiche in Festag', 'wichtigste-bereiche',
    'Kurzer Überblick über Projekte, Tasks, Statusabfragen, Teams, Reports und Veyra.',
    ['Navigation', 'Projekte', 'Tasks', 'Veyra'],
    {
      overview: 'Festag ist in wenige Kernbereiche gegliedert: Projekte, Tasks, Teams, Reports, Statusabfrage und Veyra AI.',
      explanation: [
  ...
  article('Erste Schritte', 'Festag für neue Nutzer erklärt', 'festag-fuer-neue-nutzer',
    ...
    ['Einführung', 'Neue Nutzer', 'Produkt'],
    {
      ...
      explanation: [
        ...
        'Neue Nutzer müssen nicht alle Details kennen. Sie können mit Projektübersicht, Statusberichten und Veyra-Briefings starten.',
      ],
  ...
  article('Projekte', 'Ein neues Projekt anlegen', 'projekt-anlegen',
    ...
    ['Projekte', 'Projektanlage', 'Start'],
    {
      ...
      explanation: [
        ...
        'Diese Informationen helfen Veyra später, Statusberichte, nächste Schritte und Risiken sinnvoll einzuordnen.',
      ],
  ...
  article('Projekte', 'Projektansicht verstehen', 'projektansicht-verstehen',
    ...
    ['Projektansicht', 'Details', 'Tasks'],
    {
      ...
      explanation: [
        ...
        'Statusberichte und Veyra-Hinweise helfen, die Detailinformationen in eine verständliche Lage zu übersetzen.',
      ],
  ...
  article('Projekte', 'Nächste Schritte in Projekten planen', 'naechste-schritte-planen',
    ...
    ['Nächste Schritte', 'Planung', 'Veyra'],
    {
      ...
      explanation: [
        ...
        'Veyra kann aus Beschreibungen und Statusberichten Vorschläge ableiten, die vor dem Ausführen bestätigt werden.',
      ],
  ...
  article('Aufgaben & operative Arbeit', 'Offene Punkte erkennen', 'offene-punkte-erkennen',
    ...
    ['Offene Punkte', 'Risiken', 'Entscheidungen'],
    {
      ...
      explanation: [
        ...
        'Veyra kann sie in Berichten sichtbar machen und daraus bestätigungspflichtige Vorschläge ableiten.',
      ],
  ...
  article('Statusabfragen', 'Was ist eine Statusabfrage?', 'was-ist-eine-statusabfrage',
    ...
    ['Statusabfrage', 'Updates', 'Transparenz'],
    {
      ...
      explanation: [
        ...
        'Veyra kann Antworten später zusammenfassen und daraus Statusberichte, Risiken oder nächste Schritte ableiten.',
      ],
  ...
  article('Statusabfragen', 'Statusabfragen erstellen', 'statusabfragen-erstellen',
    ...
    ['Statusabfragen', 'Erstellen', 'Updates'],
    {
      ...
      explanation: [
        ...
        'Je klarer die Abfrage, desto besser kann Veyra die Antworten später strukturieren.',
      ],
  ...
  article('Statusabfragen', 'Statusabfragen an Teammitglieder senden', 'statusabfragen-senden',
    ...
    ['Team', 'Updates', 'Rhythmus'],
    {
      ...
      example: 'Ein Team gibt jeden Freitag kurze Projektupdates ab, aus denen Veyra eine Wochenübersicht erstellt.',
  ...
  article('Statusabfragen', 'Antworten aus Statusabfragen verstehen', 'antworten-aus-statusabfragen',
    ...
    ['Antworten', 'Auswertung', 'Veyra'],
    {
      ...
      explanation: [
        ...
        'Veyra kann daraus lesbare Zusammenfassungen und Hinweise auf Risiken oder Entscheidungen erstellen.',
      ],
  ...
  article('Veyra AI', 'Was ist Veyra?', 'was-ist-tagro',
    'Lerne, wie Veyra Projektinformationen in klare Statusberichte, Einschätzungen und Briefings übersetzt.',
    ['Veyra', 'AI', 'Briefings', 'Statusberichte'],
    {
      overview: 'Veyra ist die intelligente Strukturierungsschicht von Festag.',
      explanation: [
        'Veyra liest Projektinformationen, Aufgaben, Updates und Statusberichte im jeweiligen Kontext.',
      ...
      example: 'Aus verstreuten Aufgaben und Updates formuliert Veyra eine kurze Lage mit offenen Reviews und Risiken.',
      nextStep: 'Öffne Veyra Chat, wenn du eine konkrete Frage zu Projekten oder Entscheidungen hast.',
    }, true),
  article('Veyra AI', 'Wie Veyra Projektinformationen strukturiert', 'wie-tagro-projektinformationen-strukturiert',
    'Wie aus Eingaben, Aufgaben und Updates klare Zusammenfassungen entstehen.',
    ['Veyra', 'Struktur', 'Zusammenfassungen'],
    {
      overview: 'Veyra sortiert Informationen nach Projekt, Status, Risiko, Entscheidung und nächstem Schritt.',
      explanation: [
        'Nicht jede Information ist gleich wichtig. Veyra trennt Fortschritt von Blockern und konkrete Entscheidungen von allgemeinem Kontext.',
      ...
      nextStep: 'Nutze klare Projekt- und Taskdaten, damit Veyra präzisere Zusammenfassungen erstellen kann.',
    }),
  article('Veyra AI', 'Warum Veyra nicht wie ein klassischer Chatbot arbeitet', 'tagro-kein-klassischer-chatbot',
    'Veyra fragt nicht unnötig viel, sondern registriert, strukturiert und bereitet nächste Schritte vor.',
    ['Veyra', 'Chat', 'Arbeitsweise'],
    {
      overview: 'Veyra ist kein Support-Chat, sondern eine Arbeitsoberfläche für Projektsteuerung.',
      explanation: [
        'Viele Chatbots reagieren nur auf einzelne Fragen. Veyra arbeitet mit dem vorhandenen Festag-Kontext.',
        'Wichtige Aktionen wie Tasks erstellen oder Reviews freigeben werden vorbereitet, aber nicht ohne Bestätigung ausgeführt.',
      ],
      example: 'Wenn du nach Risiken fragst, prüft Veyra Projektlage und Aufgaben statt eine allgemeine Antwort zu geben.',
      nextStep: 'Formuliere Fragen projektbezogen, zum Beispiel: "Welche Entscheidungen blockieren Client Portal?"',
    }),
  article('Veyra AI', 'Veyra Einschätzungen verstehen', 'tagro-einschaetzungen-verstehen',
    'Wie Veyra Risiken, Fortschritt und nächste Schritte zusammenfasst.',
    ['Risiken', 'Fortschritt', 'Veyra'],
    {
      overview: 'Veyra-Einschätzungen sind Hinweise, keine unsichtbaren Entscheidungen.',
      explanation: [
        'Veyra zeigt, warum ein Thema relevant sein könnte: blockierte Aufgaben, wartende Freigaben oder fehlende Updates.',
        'Die finale Entscheidung bleibt beim Nutzer oder der verantwortlichen Rolle.',
      ],
      example: 'Veyra kann sagen: "Ein Review ist seit drei Tagen offen und blockiert den nächsten Schritt."',
      nextStep: 'Nutze Einschätzungen als Startpunkt für Prüfung, nicht als automatische Wahrheit.',
    }),
  article('Veyra AI', 'Veyra bei neuen Projekten', 'tagro-bei-neuen-projekten',
    'Wie Veyra Projektbeschreibungen verarbeitet und abhängig von der Umsetzungsart reagiert.',
    ['Neue Projekte', 'Veyra', 'Projektanlage'],
    {
      overview: 'Bei neuen Projekten hilft Veyra, aus einer Beschreibung eine erste Struktur zu machen.',
      explanation: [
        'Je nach Projektart kann Veyra nächste Schritte, offene Fragen oder mögliche Aufgaben vorschlagen.',
      ...
      nextStep: 'Beschreibe ein neues Projekt so konkret wie möglich und prüfe Veyras Vorschläge.',
    }),
  article('Veyra AI', 'Veyra für Führungskräfte', 'tagro-fuer-fuehrungskraefte',
    'Wie CEOs, Gründer und Entscheider schnell Überblick über laufende Arbeit erhalten.',
    ['CEO', 'Führung', 'Entscheidungen'],
    {
      overview: 'Für Führungskräfte reduziert Veyra die Zeit zwischen Information und Entscheidung.',
      explanation: [
      ...
      nextStep: 'Nutze Veyra für Fragen wie: "Was ist heute wichtig?" oder "Was blockiert Delivery?"',
    }),
  ...
  article('Reports & Briefings', 'Audio-Briefings mit Veyra', 'audio-briefings-mit-tagro',
    'Wie kurze Audio-Zusammenfassungen aus Statusberichten entstehen.',
    ['Audio', 'Briefings', 'Veyra'],
    {
      overview: 'Audio-Briefings machen Statusberichte hörbar.',
      explanation: [
        'Veyra nutzt den schriftlichen Bericht oder den Projektkontext und erstellt daraus eine kurze gesprochene Lage.',
  ...
  article('Teams & Rollen', 'Mit externen Entwicklern arbeiten', 'mit-externen-entwicklern-arbeiten',
    ...
    ['Externe Entwickler', 'Teams', 'Transparenz'],
    {
      ...
      example: 'Ein externer Entwickler gibt Updates ab, Veyra macht daraus eine kurze Kundenlage.',
  ...
  article('Aufgaben & operative Arbeit', 'Entscheidungen als eigene Fläche', 'entscheidungen',
    ...
    ['Entscheidungen', 'Workflow', 'Veyra', 'Verantwortung'],
    {
      ...
      explanation: [
        ...
        'Auf `/decisions` öffnet ein Klick auf die Zeile einen Drawer mit Frage, Kontext und Optionen. Veyra kann auf Knopfdruck eine Empfehlung mit kurzer Begründung liefern; der Kunde übernimmt sie mit einem weiteren Klick oder schreibt eine eigene Antwort.',
      ...
      example: 'Ein Developer fragt: „Welcher Hosting-Provider soll es werden?" mit drei Optionen. Veyra empfiehlt nach kurzer Analyse Option B und nennt den Grund. Der Kunde bestätigt mit einem Klick — der Developer bekommt sofort die Antwort und arbeitet weiter, ohne dass jemand im Chat nachfragen musste.',
  ...
  article('Veyra AI', 'Notizen mit Veyra', 'notizen-mit-tagro',
    'Wie der Notizbereich in Festag funktioniert: vier Typen, [[Backlinks]], Veyra-Analyse und eine direkte Übergabe an den Chat.',
    ['Notizen', 'Veyra', 'Backlinks', 'Workflow'],
    {
      overview: 'Notizen sind nicht einfach Textblöcke, sondern eine eigene Arbeitsfläche mit klarer Logik. Beim Anlegen wird ein Typ gewählt — Journal, Brief, Meeting oder Research — der bestimmt, wie Veyra die Notiz später liest.',
      explanation: [
        'Beim Klick auf „Neue Notiz" öffnet sich ein Composer-Modal, das nach Titel, Inhalt, Typ, Projekt und Tags fragt. Direkt unten sitzen drei Pfade: ruhig anlegen, mit Veyra analysieren oder als Kontext an den Veyra-Chat übergeben.',
        'Im Editor erkennt Veyra die Notiz typabhängig: Briefs werden in konkrete Tasks zerlegt, Journals in Themen, Meeting-Protokolle in Folgepunkte, Research in Risiken und Lücken. Die Vorschläge erscheinen in einem ruhigen Panel innerhalb der Notiz.',
      ...
      example: 'Während eines Kundencalls wird eine Meeting-Notiz angelegt. Veyra liest sie anschließend und schlägt drei Folgepunkte sowie eine Risiko-Frage vor. Mit einem Klick werden die Folgepunkte zu echten Tasks im verknüpften Projekt.',
  ...
  article('Statusabfragen', '„Heute im Fokus" auf dem Dashboard', 'heute-im-fokus',
    ...
    ['Dashboard', 'Statusabfrage', 'Entscheidungen', 'Risiken'],
    {
      ...
      explanation: [
        ...
        'Die fette weiße CTA darunter — „Statusbericht schreiben" oder „Neuen Statusbericht schreiben" — schreibt mit einem Klick einen frischen Veyra-Bericht direkt in den Notizblock links. Kein zusätzlicher Dialog, keine Wartezeit.',
      ],
  ...
  article('Erste Schritte', 'Posteingang verstehen', 'posteingang-verstehen',
    ...
    {
      overview: 'Der Festag-Posteingang ist kein Chat-Strom, sondern eine kategorisierte Liste strukturierter Eingänge: Projekt-Updates, Rechnungen, Konto-Events und Veyra-Assists liegen sauber getrennt in einer einzigen Spalte.',
      explanation: [
        ...
        'Eingänge entstehen automatisch — aus Status-Updates des Developer-Teams, aus Veyra-Zusammenfassungen, aus Decision-Requests und aus System-Events wie Rechnungen oder Vertragsversand. Manuelles Sortieren fällt weg.',
      ...
      example: 'Nach dem Mittag öffnet ein Kunde den Posteingang. Drei Eingänge sind ungelesen: ein Veyra-Briefing zum Stand der Landingpage, eine Rechnung des Vormonats und eine Entscheidungsanfrage. Mit drei Klicks ist alles eingeordnet.',
  ...
  richArticle('Veyra AI', 'Entscheidungen in Festag', 'entscheidungen-in-festag',
    'Wie Auftraggeber und Auftragnehmer über Veyra saubere Entscheidungen treffen — ohne Chat-Chaos, ohne Missverständnisse, mit klarer Verantwortung.',
    ['Entscheidungen', 'Decision Engine', 'Veyra', 'Trust Layer', 'Dev Panel', 'Client Board'],
    [
      { type: 'lead', text: 'Eine Entscheidung ist die einzige formale Form, in der Auftraggeber und Auftragnehmer einander wirklich verpflichten. Veyra ist die Sprache, in der diese Verpflichtung geschrieben wird.' },
      ...
      { type: 'kvtable', rows: [
        ...
        ['Veyra Backend', 'Notar und Übersetzer. Rahmt die Entscheidung, formuliert beide Sichten, routet an die richtige Rolle, propagiert das Ergebnis. Selbst nie Entscheidungsträger, außer es ist explizit erlaubt.'],
        ['Dev Panel', 'Technisch und vollständig. Verlinkte Tasks, Begründung, Veyra-Vorschlag mit Reasoning, mögliche Verfeinerung vor dem Versand an den Client.'],
      ]},

      { type: 'heading', level: 2, text: 'Wer eine Entscheidung erzeugt', id: 'erzeugung' },
      { type: 'paragraph', text: 'Am Projektstart kommen Entscheidungen fast ausschließlich vom Dev. Er weiß, welche technischen oder organisatorischen Fragen beantwortet werden müssen, bevor er weiterarbeiten kann. Veyra hat in dieser Phase noch keinen ausreichenden Kontext, um eigenständig zu erkennen, was offen ist — sie ist hier reine Übersetzerin und Routerin.' },
      { type: 'paragraph', text: 'Sobald das Projekt läuft, kommen weitere Quellen dazu. Statusberichte, Blocker, Risikoindikatoren und Scope-Vergleiche füttern Veyra mit genug Signal, um Entscheidungsbedarf eigenständig zu erkennen. Auch dann bleibt der Dev der dominante Ursprung — Veyra ergänzt, sie ersetzt nicht.' },
      { type: 'list', items: [
        'Vage Tasks ohne klare Akzeptanzkriterien — Veyra fragt nach, statt zu raten.',
      ...
      { type: 'note', text: 'Veyra erzeugt maximal drei automatische Entscheidungen pro Projekt und Tag. Mehr wäre eine Belastung statt einer Hilfe. Nur kritische Themen umgehen dieses Limit.' },

      { type: 'heading', level: 2, text: 'Was Veyra für jede Entscheidung liefert', id: 'framing' },
      { type: 'paragraph', text: 'Bevor eine Entscheidung dem Auftraggeber gezeigt wird, prüft Veyra, ob sie vollständig gerahmt ist. Ohne die folgenden Elemente bleibt sie im Entwurf und erreicht das Client Board nicht.' },
      { type: 'list', ordered: true, items: [
        ...
        'Eine Veyra-Empfehlung in einer einzigen Zeile — oder die ehrliche Aussage, dass keine Empfehlung möglich ist.',
      ]},

      { type: 'heading', level: 2, text: 'Wie der Auftraggeber antwortet', id: 'antworten' },
      { type: 'paragraph', text: 'Nicht jede Entscheidung sieht gleich aus. Manche brauchen ein einfaches Ja oder Nein, andere eine Auswahl, andere einen kurzen Text. Veyra erkennt den passenden Antworttyp aus dem Kontext und schlägt ihn dem Dev vor, der die Frage stellt.' },
      { type: 'kvtable', rows: [
      ...
      { type: 'heading', level: 2, text: 'Veyra entscheiden lassen', id: 'delegation' },
      { type: 'paragraph', text: 'Neben den vier Antworttypen gibt es eine fünfte Möglichkeit, die jede Entscheidung still im Hintergrund mitführt: Der Auftraggeber kann Veyra bitten, für ihn zu entscheiden.' },
      { type: 'paragraph', text: 'Das ist kein Verzicht auf Kontrolle, sondern das Gegenteil. Der Auftraggeber entscheidet pro Entscheidung neu, wem er die Wahl überlässt. Veyra lernt mit jeder Delegation die Präferenzen des Projekts kennen — Tonalität, Risikoneigung, Designgeschmack — und kann zukünftige Vorschläge präziser rahmen.' },
      ...
      { type: 'paragraph', text: 'Eine Entscheidung im Status „decided" ist erst der zweite Schritt von dreien. Anschließend übersetzt Veyra die Wahl in konkrete Wirkung im Projekt — atomar, idempotent, mit vollständigem Audit-Trail.' },
      { type: 'mono', text: [
        ...
        '   +-- betroffene Tasks: Veyra hängt eine Notiz an, ggf. neue Akzeptanzkriterien',
      ...
      { type: 'heading', level: 2, text: 'Was Veyra niemals tut', id: 'grenzen' },
      { type: 'list', items: [
        'Veyra erfindet keine Fragen, die der Dev nicht gestellt hat. Halluzination im Trust Layer wäre fatal.',
        'Veyra entscheidet nicht eigenständig, außer der Auftraggeber hat die Entscheidung explizit an sie delegiert oder es handelt sich um einen ausdrücklich erlaubten Trivial-Default.',
        'Veyra schätzt keine Auswirkungen, die sie nicht belegen kann. Unbekanntes wird als unbekannt markiert, nicht geraten.',
        'Veyra umgeht niemals die Autoritätsregeln. Wer entscheiden darf, ist im Datenmodell fixiert — Rolle, nicht Person.',
        'Veyra entscheidet nie rechtliche, finanzielle oder vertragliche Fragen. Diese sind explizit ausgeschlossen.',
      ]},
      ...
      { type: 'paragraph', text: 'Auf dem Client Board liegt eine Entscheidung als ruhige Karte im Bereich „Entscheidungen". Maximal drei Karten sind primär sichtbar, weiteres rutscht in einen sekundären Bereich. Eine Karte zeigt Titel, Zusammenfassung, Optionen und eine einzelne Empfehlung. Daneben gibt es die Möglichkeit, die Entscheidung zu diskutieren — eine Rückfrage, die wieder bei Veyra landet und in eine geschärfte Version mündet.' },
      { type: 'paragraph', text: 'Im Dev Panel taucht jede aktive Entscheidung am Kopf des Projekt-Workspaces auf. Blockierte Tasks zeigen direkt, welche Entscheidung sie aufhält. Mit der Aktion „Entscheidung anfragen" an einem Task lässt sich eine neue Frage anstoßen — Veyra übernimmt das Rahmen und Übersetzen.' },
      { type: 'paragraph', text: 'Hinter beidem läuft Veyra als stille Schicht. Sie hat kein eigenes UI, sie ist die Schreibweise des Systems. Sichtbar wird sie nur im Audit-Log und in der ruhigen Tatsache, dass beide Seiten verstanden haben, was die andere meint.' },
    ], true, '7 Min.'),
  ...
  richArticle('Sicherheit & Vertrauen', 'Die Festag-Garantie', 'festag-garantie',
    ...
    [
      { type: 'lead', text: 'Wenn du ein Projekt über Festag vergibst, gibst du kein Briefing in eine Blackbox. Die Festag-Garantie sichert zu, dass dein Projekt von einem geprüften Entwickler umgesetzt, von Veyra begleitet und in einem nachvollziehbaren Ablauf zu Ende geführt wird.' },
      ...
      { type: 'list', items: [
        ...
        'Veyra als durchgehende Begleitung: Jeder Arbeitsschritt wird von Veyra in einen verständlichen Stand für dich übersetzt. Du musst nichts Technisches lesen, um zu wissen, wo dein Projekt steht.',
      ...
      { type: 'paragraph', text: 'Festag liefert dir keine ungefilterten Entwickler-Meldungen. Veyra prüft jedes Update auf Relevanz und Verständlichkeit, bevor es bei dir als Projektstand ankommt. „Fertig" heißt bei Festag: von Veyra entlang klarer Achsen geprüft — nicht nur als erledigt markiert.' },
