...
export const festagDocsArticles: FestagDocArticle[] = [
  richArticle('Tagro AI', 'Vom Dev-Update zur ruhigen Client-Lage', 'tagro-statusbriefing',
    'Wie der tägliche 16:00-Loop funktioniert, was Tagro aus Dev-Updates baut und warum Reporting bei Festag operative Steuerung ist, nicht Doku.',
    ['Tagro', 'Statusbriefing', 'Dev-Updates', 'Client-Lage', 'Reports'],
    [
      { type: 'lead', text: 'Festag trennt interne Arbeitsrealität von client-fähiger Lage. Tagro sitzt dazwischen: sie liest Arbeitssignale, prüft Relevanz und formuliert daraus verständliche Statusberichte.' },
      { type: 'mono', text: [
        '16:00 Berlin',
        '   |',
        '   v',
      ...
      { type: 'paragraph', text: 'Genau dafür sitzt Tagro zwischen Ausführung und Client-Sicht. Die Arbeitsrealität bleibt vollständig dokumentiert, aber die Client-Kommunikation wird bewusst klar, kurz und professionell.' },

      { type: 'heading', level: 2, text: 'Der tägliche Status ist kein Chat', id: 'kein-chat' },
      { type: 'paragraph', text: 'Das Developer-Update ist bewusst klein: ein Satz, ein Fortschritt, ein Blocker oder ein Hinweis. Tagro sammelt diese Signale über 24 Stunden und macht daraus eine Lage, die im Dashboard, in Statusberichten und optional als Audio verfügbar ist.' },
      { type: 'list', items: [
      ...
      { type: 'paragraph', text: 'Ein Statusbericht ist nicht das Ende der Arbeit. Wenn Tagro einen offenen Punkt erkennt, kann daraus eine Aufgabe, ein Risiko, eine Entscheidung oder ein Projektbriefing entstehen. So wird Reporting nicht nur Dokumentation, sondern operative Steuerung.' },
      { type: 'list', ordered: true, items: [
        'Dev gibt tägliches Update ab.',
        'Tagro baut daraus eine verständliche Lage.',
      ...
      { type: 'quote', text: 'Zielbild: Der Client öffnet Festag, hört ein 30- bis 60-sekündiges Tagro-Briefing und versteht sofort, was passiert ist, was blockiert ist und worauf er achten muss.' },
    ], true, '6 Min.'),
