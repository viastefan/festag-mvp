 ...
 * Accent primary stays slate `#5B647D` (Google / focus / light primary actions).
 */
...
export const FESTAG_SAND = {
  ...
  readyHover: '#F7F2E8',
  readyActive: '#EFE8DC',
  /** Slate primary — Google + accent + light primary CTAs. */
  primary: '#5B647D',
  primaryHover: '#6A738C',
  primaryActive: '#4A5368',
  primaryFg: '#F5F6F8',
  /** Quiet blue wash — hovers / soft accents on sand. */
  primarySoft: 'rgba(91, 100, 125, 0.08)',
  primarySoftHover: 'rgba(91, 100, 125, 0.12)',
  primaryBorder: 'rgba(91, 100, 125, 0.22)',
  muted: '#8a8378',
  ink: '#1e1e20',
} as const
...
export const FESTAG_SAND_BODY_WASH = `
  radial-gradient(ellipse 90% 55% at 18% -8%, rgba(236, 176, 128, 0.14), transparent 58%),
  radial-gradient(ellipse 55% 40% at 78% 8%, rgba(91, 100, 125, 0.07), transparent 55%),
  radial-gradient(ellipse 70% 50% at 92% 108%, rgba(220, 154, 108, 0.09), transparent 55%),
